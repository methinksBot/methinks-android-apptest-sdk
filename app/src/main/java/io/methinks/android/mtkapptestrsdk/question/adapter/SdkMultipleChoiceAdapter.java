...
import io.methinks.mtkpatchersdk.lib.sectionedrecyclerviewadapter.StatelessSection;
...
public class SdkMultipleChoiceAdapter extends StatelessSection {
    ...
    public SdkMultipleChoiceAdapter(Context context, String question, String objectId, ArrayList<String> choices, Boolean multipleSelection, Boolean isShuffleOrder, HashMap<String, ArrayList<Object>> answerMap) {
        ...
        this.isShuffleOrder = isShuffleOrder;

        if (this.isShuffleOrder) {
            if (ViewControllerManager.cache != null) {
                if (ViewControllerManager.cache.containsKey(objId)) {
                    this.choices = (ArrayList<String>) ViewControllerManager.cache.get(objId);
                } else {
                    shuffleArrayList(this.choices);
                    ViewControllerManager.cache.put(objId, this.choices);
                }
            }
        }
    ...
    public boolean validate() {
        ArrayList<Object> answer = answerMap.get(objId);
