...
import io.methinks.android.apptest.sectionedrecyclerviewadapter.Section.State;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private LinkedHashMap<String, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section> sections;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        for (Map.Entry<String, Integer> entry : sectionViewTypeNumbers.entrySet()) {
            if (viewType >= entry.getValue() && viewType < entry.getValue() + VIEW_TYPE_QTY) {
                ...
                io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section = sections.get(entry.getKey());
    ...
    private RecyclerView.ViewHolder getItemViewHolder(ViewGroup parent, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
    ...
    private RecyclerView.ViewHolder getHeaderViewHolder(ViewGroup parent, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
    ...
    private RecyclerView.ViewHolder getFooterViewHolder(ViewGroup parent, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
    ...
    private RecyclerView.ViewHolder getLoadingViewHolder(ViewGroup parent, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
    ...
    private RecyclerView.ViewHolder getFailedViewHolder(ViewGroup parent, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
    ...
    private RecyclerView.ViewHolder getEmptyViewHolder(ViewGroup parent, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     */
    public void addSection(String tag, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     */
    public String addSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @return section
     */
    public io.methinks.android.apptest.sectionedrecyclerviewadapter.Section getSection(String tag) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        for (Map.Entry<String, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section> entry : sections.entrySet()) {
            io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section = entry.getValue();
     ...
     */
    public io.methinks.android.apptest.sectionedrecyclerviewadapter.Section getSectionForPosition(int position) {
    ...
    public int getSectionPosition(String tag) {
        io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section = getValidSectionOrThrowException(tag);
     ...
     * @return position of the section in the adapter
     */
    public int getSectionPosition(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
        int currentPos = 0;

        for (Map.Entry<String, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section> entry : sections.entrySet()) {
            io.methinks.android.apptest.sectionedrecyclerviewadapter.Section loopSection = entry.getValue();
     ...
     */
    public LinkedHashMap<String, io.methinks.android.apptest.sectionedrecyclerviewadapter.Section> getSectionsMap() {
        return sections;
    }
     ...
     * @return position of the item in the adapter
     */
    public int getPositionInAdapter(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int position) {
     ...
     * @return position of the header in the adapter
     */
    public int getHeaderPositionInAdapter(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
        if (!section.hasHeader) {
     ...
     * @return position of the footer in the adapter
     */
    public int getFooterPositionInAdapter(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
        if (!section.hasFooter) {
     ...
     * @param position position of the item in the section
     */
    public void notifyItemInsertedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int position) {
     ...
     * @param itemCount number of items inserted in the section
     */
    public void notifyItemRangeInsertedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int positionStart, int itemCount) {
     ...
     * @param position position of the item in the section
     */
    public void notifyItemRemovedFromSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int position) {
     ...
     * @param itemCount number of items removed from the section
     */
    public void notifyItemRangeRemovedFromSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int positionStart, int itemCount) {
     ...
     * @param position position of the item in the section
     */
    public void notifyItemChangedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int position) {
     ...
     * @param section a visible section of this adapter
     */
    public void notifyHeaderChangedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param section a visible section of this adapter
     */
    public void notifyFooterChangedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param itemCount number of items changed in the section
     */
    public void notifyItemRangeChangedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int positionStart, int itemCount) {
     ...
     * @param toPosition new position of the item in the section
     */
    public void notifyItemMovedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int fromPosition, int toPosition) {
     ...
     * @param previousState previous state of section
     */
    public void notifyNotLoadedStateChanged(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, State previousState) {
     ...
     * @param previousState previous state of section
     */
    public void notifyStateChangedToLoaded(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, State previousState) {
        State state = section.getState();
     ...
     * @param previousContentItemsCount previous content items count of section
     */
    public void notifyStateChangedFromLoaded(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int previousContentItemsCount) {
        State state = section.getState();
     ...
     * @param section a visible section of this adapter
     */
    public void notifyHeaderInsertedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param section a visible section of this adapter
     */
    public void notifyFooterInsertedInSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param section a visible section of this adapter
     */
    public void notifyHeaderRemovedFromSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param section a visible section of this adapter
     */
    public void notifyFooterRemovedFromSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param section a visible section of this adapter
     */
    public void notifySectionChangedToVisible(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section) {
     ...
     * @param previousSectionPosition previous section position
     */
    public void notifySectionChangedToInvisible(io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section, int previousSectionPosition) {
        if (section.isVisible()) {
            throw new IllegalStateException("This section is not visible.");
        }
    ...
    @NonNull
    private io.methinks.android.apptest.sectionedrecyclerviewadapter.Section getValidSectionOrThrowException(String tag) {
        io.methinks.android.apptest.sectionedrecyclerviewadapter.Section section = getSection(tag);
