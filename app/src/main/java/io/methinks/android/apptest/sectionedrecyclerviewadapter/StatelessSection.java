 ...
 */
public abstract class StatelessSection extends io.methinks.android.apptest.sectionedrecyclerviewadapter.Section {
    ...
    public StatelessSection(@LayoutRes int itemResourceId) {
        this(new io.methinks.android.apptest.sectionedrecyclerviewadapter.SectionParameters.Builder(itemResourceId)
                .build());
    }
     ...
     */
    public StatelessSection(io.methinks.android.apptest.sectionedrecyclerviewadapter.SectionParameters sectionParameters) {
