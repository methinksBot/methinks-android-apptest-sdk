...
public abstract class Section {
     ...
     */
    public Section(io.methinks.android.apptest.sectionedrecyclerviewadapter.SectionParameters sectionParameters) {
    ...
    public RecyclerView.ViewHolder getHeaderViewHolder(View view) {
        return new io.methinks.android.apptest.sectionedrecyclerviewadapter.SectionedRecyclerViewAdapter.EmptyViewHolder(view);
    }
